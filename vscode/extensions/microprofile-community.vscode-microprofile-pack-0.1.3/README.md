...
## Contributing
Do you have a suggestion for the Extension Pack for MicroProfile? File an [issue](https://github.com/MicroShed/vscode-microprofile-pack/issues) or submit a pull request if there is an extension that should be added to the extension pack.  Our [CONTRIBUTING](https://github.com/MicroShed/vscode-microprofile-pack/blob/HEAD/CONTRIBUTING.md) document contains details for submitting pull requests.
