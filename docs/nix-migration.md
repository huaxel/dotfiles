...
Manager package baseline. Existing Homebrew Herdr installations can be removed
after a successful activation; Homebrew remains responsible for GUI
applications and macOS-integrated tools.
