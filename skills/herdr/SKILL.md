---
name: herdr
description: "Control Herdr, a terminal multiplexer for coding agents. Use proactively for pane-based delegation, parallel work, and terminal control when running inside Herdr. Requires HERDR_ENV=1."
---
