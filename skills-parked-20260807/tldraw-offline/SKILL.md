...
```bash
PORT=$(jq -r .port '/Users/juanbenjumea/Library/Application Support/tldraw/server.json'); TOKEN=$(jq -r .token '/Users/juanbenjumea/Library/Application Support/tldraw/server.json')
