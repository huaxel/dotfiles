...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.3.0/arm64-darwin24")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/juanbenjumea/.rbenv/versions/3.3.6")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/juanbenjumea/.rbenv/versions/3.3.6' '--with-openssl-dir=/opt/homebrew/opt/openssl@3' '--enable-shared' '--with-libyaml-dir=/opt/homebrew/opt/libyaml' '--with-gmp-dir=/opt/homebrew/opt/gmp' '--with-ext=openssl,psych,+' 'CC=clang'"
  ...
  CONFIG["arch"] = "arm64-darwin24"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/juanbenjumea/.rbenv/versions/3.3.6"
  ...
  CONFIG["DLDFLAGS"] = "-L/opt/homebrew/opt/gmp/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["incflags"] = "-I/opt/homebrew/opt/gmp/include"
  ...
  CONFIG["ARFLAGS"] = "rcu "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 16.0.0 (clang-1600.0.26.4)\nTarget: arm64-apple-darwin24.1.0\nThread model: posix\nInstalledDir: /Library/Developer/CommandLineTools/usr/bin"
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/opt/homebrew/opt/gmp/lib"
  ...
  CONFIG["host"] = "$(target)"
  CONFIG["build_os"] = "darwin24.1.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "aarch64"
  CONFIG["build"] = "aarch64-apple-darwin24.1.0"
