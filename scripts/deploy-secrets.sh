...
echo "   Removed or commented-out keys linger in processes started before the"
echo "   edit — restart long-running shells and agents (or 'wsl.exe --shutdown'"
echo "   on WSL) so nothing inherits stale values."
