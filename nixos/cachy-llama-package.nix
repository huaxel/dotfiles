# Adapted from CachyLLama c1627fa4b8526fe146bccb3ca228f3dd0838517c
# .devops/nix/package.nix (MIT). Keep in sync with the pinned input.
# Local changes: explicit source root and modern hostPlatform accessors.
# Remove this copy when upstream packaging supports our pinned nixpkgs.
{
  lib,
  cachySource,
  glibc,
...
effectiveStdenv.mkDerivation (finalAttrs: {
  ...
  src = lib.cleanSourceWith {
    ...
    src = lib.cleanSource cachySource;
  };
  ...
  webui = stdenvNoCC.mkDerivation {
    pname = "webui";
    version = llamaVersion;
    src = lib.cleanSource (cachySource + "/tools/ui");
